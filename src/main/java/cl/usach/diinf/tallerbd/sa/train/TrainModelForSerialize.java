...
public class TrainModelForSerialize {
	public static void main(String[] args) throws Exception {
		...
		// se realiza el entrenamiento con el 100% de los tweets.
		...
		System.out.println(modeleval.toClassDetailsString());
		 ...
		 // guardar los atributos usados, que en este caso son las palabras.
		 ...
		 // se guardan los attrs
		 FileUtils.write(new File("src/main/resources/model/attrs.dat"), attrs.toString());
